#define Version "Semaphore 2.6 2022/04/29"
// Set varable speed for up and down blade motion
// "Semaphore 2.5 2022/03/09 01:30"
//  -- Switched Servo library from Servo to VarSpeedServo
// "Semaphore 2.4 2021/08/02 14:30"
...
int Ioff, nxtpos, Grnval;
  ...
  delay (BounceDly);
    SemiP[Iset].write((Redval + nxtpos),Speed);
  delay (BounceDly);
    SemiP[Iset].write(Redval,Speed);
    nxtpos /= BounceArc;
  } while (nxtpos != 0);
  #endif
}// BounceRed
